...
function getCities(event) {
      ...
      citySelect.innerHTML = "<option value>Selecionae a cidade </option>"
...
if(alreadySelected >=0 ){
    ...
    const filteredItems = selectedItems.filter(item => {
        const itemIsDifference = item != itemId //false
...
// atualizar o campo escondido com os dados selecionados ou
//itens
